...
# set up validation
n_obs_val = 10000
x_val, y_val = x_train[:n_obs_val], y_train[:n_obs_val]
partial_x_train = x_train[n_obs_val:]
partial_y_train = y_train[n_obs_val:]

# start training
# history.history is dictionary containing all
# metrics and loss calculated during the training process
